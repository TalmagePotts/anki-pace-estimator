...
class ConfigDialog(QDialog):
    ...
    def _speed_tab(self) -> QWidget:
        ...
        self.aggregate.addItem("Median (robust — recommended)", "median")
        self.aggregate.addItem("Trimmed mean", "trimmed")
        self.aggregate.addItem("Mean", "mean")
        ...
        form.addRow("Average using", self.aggregate)
