    ...
    def _reviewer_tab(self) -> QWidget:
        ...
        lay.addWidget(
            _label(
                ...
                "clock runs quietly and a large symbol appears while the question is "
                "still up, once the card has run over its time — the point at which "
                "the useful thing to do is stop struggling and turn the card over. "
                "Switch the timer on if you would rather watch the clock, or move "
                "the warning to the answer side if you would rather not be nudged "
                "mid-recall. Per-deck times are set on the Decks tab.\n\n"
